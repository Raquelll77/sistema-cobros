...
<div class="contenedor">
    ...
    <a href="/cobros?tab=<?= htmlspecialchars($_GET['tab'] ?? 'busqueda-clientes'); ?>">Volver</a>

    <div id="frm-envio-datos" class="contenedor-95">
        <h1>Informacion del Préstamo</h1>
        ...
        <?php if ($prestamoDetalle) { ?>
            ...
            <div class="contenido-detalle">
                <?php foreach ($prestamoDetalle as $detalle) { ?>
                    ...
                    <p><strong>Fecha de nacimiento:</strong> <?php echo htmlspecialchars($detalle['fecha_nacimiento']); ?></p>
                    ...
                    <p><strong>Direccion de trabajo:</strong> <?php echo htmlspecialchars($detalle['empresa_direccion']); ?></p>
                        ...
                        <?php foreach ($historialGestiones as $gestion): ?>
                            <div class="gestion-card">
                                <div class="encabezado-gestion">
                                    <span class="codigo-resultado"><?= htmlspecialchars($gestion->codigo_resultado); ?></span>
